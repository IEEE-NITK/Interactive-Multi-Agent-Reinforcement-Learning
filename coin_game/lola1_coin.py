...
from lola_optimizer import LOLA1
...
def main():
	...
	with open(info_str, 'a') as info_ptr:
		info_ptr.write('This is run number {} of MAVPG (LOLA1). The hyperparameters are:\n\n'.format(args.run_num))
	...
	if args.lola:
		policy_optim = LOLA1(p1.parameters(), p2.parameters(), lr = args.lr_p, device = device)
	else:
		if not args.rms:
	...
	print('1Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
	print('\n')
	print('1Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
	print('\n')
	...
	for epoch in range(args.n_epochs):
		...
		for eps in range(args.n_eps):
			...
			if args.logs:
				f_ptr.write(s)
			if args.tensorboard:
				writer.add_scalar('Timesteps/Total timesteps in episode', time_in_episode, epoch * args.n_eps + eps)
		...
		print('2Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('2Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('3Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('3Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('4Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('4Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('5Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('5Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')

		advantage2 = get_advantage(v2, r2, args.gamma, args.tau).to(device)

		print('6Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('6Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('7Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('7Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('8Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('8Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('9Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('9Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('10Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('10Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('11Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('11Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')

		dist1 = Categorical(pi1_a_s)
		log_prob1 = dist1.log_prob(action_both[:,0])

		print('12Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('12Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')

		dist2 = Categorical(pi2_a_s)
		log_prob2 = dist2.log_prob(action_both[:,1])

		print('13Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('13Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('14Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('14Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('15Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('15Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('16Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('16Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('17Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('17Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('18Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('18Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('19Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('19Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		print('20Allocated: {} GB'.format(round(torch.cuda.memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		print('20Max memory allocated: {} GB'.format(round(torch.cuda.max_memory_allocated(current_device)/1024**3, 1)))
		print('\n')
		...
		if (epoch + 1) % args.interval == 0:
			...
			if args.logs:
				f_ptr.write(s)
			if args.tensorboard:
				writer.add_scalar('Coin take rate {} epochs/RED player_RED coin'.format(args.interval), (n_pR_cR_interval)/(args.interval*args.n_eps), epoch)
				writer.add_scalar('Coin take rate {} epochs/RED player_BLUE coin'.format(args.interval), (n_pR_cB_interval)/(args.interval*args.n_eps), epoch)
				writer.add_scalar('Coin take rate {} epochs/BLUE player_RED coin'.format(args.interval), (n_pB_cR_interval)/(args.interval*args.n_eps), epoch)
				writer.add_scalar('Coin take rate {} epochs/BLUE player_BLUE coin'.format(args.interval), (n_pB_cB_interval)/(args.interval*args.n_eps), epoch)
				writer.add_scalar('Coin take rate {} epochs/Draw rate'.format(args.interval), (n_draw_interval)/(args.interval*args.n_eps), epoch)
		...
		if args.tensorboard:
			writer.add_scalar('Timesteps/Total timesteps in this epoch', time_in_epoch, epoch)
			writer.add_scalar('Timesteps/Average timesteps in one episode in this epoch', avg_time_in_epoch, epoch)
			...
			writer.add_scalar('Coin take rate/RED player_RED coin', (n_pR_cR)/tot_games, epoch)
			writer.add_scalar('Coin take rate/RED player_BLUE coin', (n_pR_cB)/tot_games, epoch)
			writer.add_scalar('Coin take rate/BLUE player_RED coin', (n_pB_cR)/tot_games, epoch)
			writer.add_scalar('Coin take rate/BLUE player_BLUE coin', (n_pB_cB)/tot_games, epoch)
			writer.add_scalar('Coin take rate/Draw rate', (n_draw)/tot_games, epoch)
			
			writer.add_scalar('Time/Avg time for policy optimization', avg_t_p_opt, epoch)
			writer.add_scalar('Time/Avg time for critic optimization', avg_t_q_opt, epoch)
			writer.add_scalar('Time/Avg time for game play', avg_t_play, epoch)
			writer.add_scalar('Time/Total time for policy optimization', t_p_opt, epoch)
			writer.add_scalar('Time/Total time for critic optimization', t_q_opt, epoch)
