...
def main():
	# training settings
	parser = argparse.ArgumentParser(description = 'GDA iterated prisoner\'s dilemma')
...
#		env = iterated_prisoner_dilemma(200)
	...
	if args.logs:
		logs_file_path = env_location+experiment_name+'/ipd_gda_lr='+str(args.lr_p1)+'_'+str(args.lr_p2)+'.txt'
	...
	if args.logs:
		...
		f_ptr.write(s)
		np_file = env_location+experiment_name+'/ipd_gda_lr='+str(args.lr_p1)+'_'+str(args.lr_p2)+'_rew_prob_c_d_time.npz'
	...
	plt.grid()
	plt.savefig(env_location+experiment_name+'/ipd_gda_lr='+str(args.lr_p1)+'_'+str(args.lr_p2)+'_prob_c_d.png')
	...
	plt.legend(loc = 'upper right')
	plt.grid()
	plt.savefig(env_location+experiment_name+'/ipd_gda_lr='+str(args.lr_p1)+'_'+str(args.lr_p2)+'_avg_rew_per_epoch.png')
